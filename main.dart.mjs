...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1357: () => new AudioContext(),
      _1358: (x0,x1) => x0.createMediaElementSource(x1),
      _1359: x0 => x0.createStereoPanner(),
      _1360: (x0,x1) => x0.connect(x1),
      _1361: x0 => x0.load(),
      _1362: x0 => x0.disconnect(),
      _1363: x0 => x0.remove(),
      _1364: x0 => x0.resume(),
      _1365: x0 => x0.play(),
      _1366: x0 => x0.pause(),
      _1367: x0 => x0.close(),
      _1371: () => new SpeechSynthesisUtterance(),
      _1372: x0 => x0.pause(),
      _1373: x0 => x0.resume(),
      ...
      _1415: s => JSON.stringify(s),
      _1416: s => printToConsole(s),
      _1417: (o, p, r) => o.replaceAll(p, () => r),
      _1418: (o, p, r) => o.replace(p, () => r),
      _1419: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1420: s => s.toUpperCase(),
      _1421: s => s.trim(),
      _1422: s => s.trimLeft(),
      _1423: s => s.trimRight(),
      _1424: (string, times) => string.repeat(times),
      _1425: Function.prototype.call.bind(String.prototype.indexOf),
      _1426: (s, p, i) => s.lastIndexOf(p, i),
      _1427: (string, token) => string.split(token),
      _1428: Object.is,
      _1429: o => o instanceof Array,
      _1430: (a, i) => a.push(i),
      _1431: (a, i) => a.splice(i, 1)[0],
      _1433: (a, l) => a.length = l,
      _1434: a => a.pop(),
      _1435: (a, i) => a.splice(i, 1),
      _1436: (a, s) => a.join(s),
      _1437: (a, s, e) => a.slice(s, e),
      _1438: (a, s, e) => a.splice(s, e),
      _1439: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1440: a => a.length,
      _1442: (a, i) => a[i],
      _1443: (a, i, v) => a[i] = v,
      _1445: o => {
      ...
      _1446: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1448: o => o instanceof Uint8Array,
      _1449: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1450: o => o instanceof Int8Array,
      _1451: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1452: o => o instanceof Uint8ClampedArray,
      _1453: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1454: o => o instanceof Uint16Array,
      _1455: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1456: o => o instanceof Int16Array,
      _1457: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1458: o => o instanceof Uint32Array,
      _1459: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1460: o => o instanceof Int32Array,
      _1461: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1463: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1464: o => o instanceof Float32Array,
      _1465: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1466: o => o instanceof Float64Array,
      _1467: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1468: (t, s) => t.set(s),
      _1469: l => new DataView(new ArrayBuffer(l)),
      _1470: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1472: o => o.buffer,
      _1473: o => o.byteOffset,
      _1474: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1475: (b, o) => new DataView(b, o),
      _1476: (b, o, l) => new DataView(b, o, l),
      _1477: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1478: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1479: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1480: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1481: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1482: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1483: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1484: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1485: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1486: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1487: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1488: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1491: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1492: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1493: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1494: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1495: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1496: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1509: (ms, c) =>
      ...
      _1548: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1548(f,arguments.length,x0,x1) }),
      _1549: o => {
      ...
      _1568: x0 => x0.groups,
      _1569: x0 => x0.flags,
      _1570: x0 => x0.multiline,
      _1571: x0 => x0.ignoreCase,
      _1572: x0 => x0.unicode,
      _1573: x0 => x0.dotAll,
      _1574: (x0,x1) => { x0.lastIndex = x1 },
      _1575: (o, p) => p in o,
      _1576: (o, p) => o[p],
      _1579: (x0,x1,x2) => x0.transaction(x1,x2),
      _1580: (x0,x1) => x0.objectStore(x1),
      _1581: (x0,x1) => x0.getAllKeys(x1),
      _1582: (x0,x1) => x0.getAll(x1),
      _1584: (x0,x1) => x0.delete(x1),
      _1585: (x0,x1,x2) => x0.put(x1,x2),
      _1586: x0 => x0.clear(),
      _1587: x0 => x0.close(),
      _1589: (x0,x1,x2) => x0.open(x1,x2),
      _1590: (x0,x1) => x0.contains(x1),
      _1593: (x0,x1) => x0.createObjectStore(x1),
      ...
      _1606: (x0,x1) => x0.createElement(x1),
      ...
      _1618: () => new AbortController(),
      _1619: x0 => x0.abort(),
      _1620: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1621: (x0,x1) => globalThis.fetch(x0,x1),
      _1622: (x0,x1) => x0.get(x1),
      _1623: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1623(f,arguments.length,x0,x1,x2) }),
      _1624: (x0,x1) => x0.forEach(x1),
      _1625: x0 => x0.getReader(),
      _1626: x0 => x0.cancel(),
      _1627: x0 => x0.read(),
      ...
      _1630: x0 => x0.openCursor(),
      _1631: x0 => x0.continue(),
      ...
      _1649: Function.prototype.call.bind(BigInt.prototype.toString),
      _1650: Function.prototype.call.bind(Number.prototype.toString),
      _1651: (d, digits) => d.toFixed(digits),
      ...
      _2429: x0 => x0.error,
      _2431: (x0,x1) => { x0.src = x1 },
      _2436: (x0,x1) => { x0.crossOrigin = x1 },
      _2439: (x0,x1) => { x0.preload = x1 },
      _2443: x0 => x0.currentTime,
      _2444: (x0,x1) => { x0.currentTime = x1 },
      _2445: x0 => x0.duration,
      _2450: (x0,x1) => { x0.playbackRate = x1 },
      _2459: (x0,x1) => { x0.loop = x1 },
      _2463: (x0,x1) => { x0.volume = x1 },
      _2480: x0 => x0.code,
      _2481: x0 => x0.message,
      _3529: () => globalThis.window,
      _3569: x0 => x0.self,
      _3592: x0 => x0.navigator,
      _3621: x0 => x0.speechSynthesis,
      _3849: x0 => x0.indexedDB,
      _3968: x0 => x0.maxTouchPoints,
      _3978: x0 => x0.platform,
      _5575: x0 => x0.destination,
      _5579: x0 => x0.state,
      _6088: x0 => x0.target,
      _6128: x0 => x0.signal,
      ...
      _8671: x0 => x0.url,
      _8673: x0 => x0.status,
      _8675: x0 => x0.statusText,
      _8676: x0 => x0.headers,
      _8677: x0 => x0.body,
      _8855: (x0,x1) => { x0.onvoiceschanged = x1 },
      _8858: (x0,x1) => { x0.text = x1 },
      _8860: (x0,x1) => { x0.lang = x1 },
      _8862: (x0,x1) => { x0.voice = x1 },
      _8864: (x0,x1) => { x0.volume = x1 },
      _8866: (x0,x1) => { x0.rate = x1 },
      _8868: (x0,x1) => { x0.pitch = x1 },
      _8872: (x0,x1) => { x0.onend = x1 },
      _8874: (x0,x1) => { x0.onerror = x1 },
      _8906: x0 => x0.name,
      _8907: x0 => x0.lang,
      _10130: x0 => x0.result,
      _10131: x0 => x0.error,
      _10136: (x0,x1) => { x0.onsuccess = x1 },
      _10138: (x0,x1) => { x0.onerror = x1 },
      _10142: (x0,x1) => { x0.onupgradeneeded = x1 },
      _10160: x0 => x0.version,
      _10161: x0 => x0.objectStoreNames,
      _10228: x0 => x0.key,
      _10231: x0 => x0.value,
      _12291: x0 => x0.name,
      _13036: () => globalThis.speechSynthesis,
      _13037: (x0,x1) => { x0.lang = x1 },
      _13039: (x0,x1) => { x0.pitch = x1 },
      _13042: (x0,x1) => { x0.rate = x1 },
      _13044: (x0,x1) => { x0.text = x1 },
      _13045: (x0,x1) => { x0.voice = x1 },
      _13046: x0 => x0.voice,
      _13048: (x0,x1) => { x0.volume = x1 },
      _13049: (x0,x1) => { x0.onstart = x1 },
      _13050: (x0,x1) => { x0.onend = x1 },
      _13051: (x0,x1) => { x0.onpause = x1 },
      _13052: (x0,x1) => { x0.onresume = x1 },
      _13053: (x0,x1) => { x0.onerror = x1 },
      _13054: (x0,x1) => { x0.onboundary = x1 },
      _13056: x0 => x0.lang,
      _13057: x0 => x0.localService,
      _13058: x0 => x0.name,
